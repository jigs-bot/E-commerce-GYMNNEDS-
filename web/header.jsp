                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <h5>SUPPLI</h5>
                        <ul class="list-unstyled mb-3">
                          <li class="nav-item"><a href="suppliments.jsp" class="nav-link">ACTIVE GAINERS</a></li>
                          <li class="nav-item"><a href="suppliments.jsp" class="nav-link">CORTISOLS</a></li>
                             </ul>
                      </div>
                    </div>
                  </li>
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-6 col-lg-3">
                        ...
                        <ul class="list-unstyled mb-3">
                          <li class="nav-item"><a href="user.jsp" class="nav-link">Manage Account</a></li>
                          <li class="nav-item"><a href="order.jsp" class="nav-link">Orders</a></li>
